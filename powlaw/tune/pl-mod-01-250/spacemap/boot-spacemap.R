...
#result path 
res_path <- paste0("~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/spacemap/bootstrap/d", sprintf("%03d", dataid))
cmd <- paste("mkdir -p", res_path)
system(cmd)

#set up tuning grid 
best_tune_path <- "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/spacemap/cv_selected_tune_params_per_dataid.rds"

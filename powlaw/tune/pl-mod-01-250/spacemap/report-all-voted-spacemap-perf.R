...
basedir02 <- "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/spacemap/02-cv-xy-yy-spacemap/"
ddirs02 <- list.dirs(path = basedir02, recursive = F, full.names = T)
basedir03 <- "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/spacemap/03-cv-xy-yy-spacemap/"
...
mapv <- foreach(path = ddirs) %do% { 
  report_all_perf(path = path, method = "spacemap", truth = truth)
}
library(data.table)
map_voted <- rbindlist(mapv)
setkey(map_voted, comparison)
saveRDS(map_voted, file = "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/spacemap/spacemap_all_tuning_cv_vote_results.rds")
save.image(file = "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/spacemap/spacemap_all_tuning_cv_vote_results.rda")

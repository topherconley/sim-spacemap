...
basedir02 <- "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/scggm/01-cv-xy-yy-scggm/"
ddirs02 <- list.dirs(path = basedir02, recursive = F, full.names = T)
basedir03 <- "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/scggm/02-cv-xy-yy-scggm/"
...
saveRDS(map_voted, file = "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/scggm/scggm_all_tuning_cv_vote_results.rds")
save.image(file = "~/scratch-data/sim-spacemap/powlaw/pl-mod-01/results/n250/scggm/scggm_all_tuning_cv_vote_results.rda")

...
#result path 
res_path <- paste0("/home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/scggm/01-cv-xy-yy-scggm/d", sprintf("%03d", dataid))
...
tsc <- expand.grid(lam1 = default_grid,
                   lam2 = default_grid)

...
#result path 
res_path <- paste0("/home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/scggm/02-cv-xy-yy-scggm/d", sprintf("%03d", dataid))
...
tsc <- expand.grid(lam1 = exp(seq(log(0.06), log(0.33), length  = 10)),

...
#SBATCH -o /home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/spacemap/02-cv-xy-yy-spacemap/logs/d%j.out
#SBATCH -e /home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/spacemap/02-cv-xy-yy-spacemap/logs/d%j.err
...
/usr/bin/R --no-save --no-restore --no-site-file --no-init-file  --args ${SLURM_ARRAY_TASK_ID} 4 < 02-cv-xy-yy-spacemap.R 

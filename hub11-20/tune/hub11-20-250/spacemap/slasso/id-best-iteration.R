...
tt <- readRDS("/home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/train-test-partition.rds")
testSetLen <- sapply(tt$test, length)
library(spacemap)

basedir <- "/home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/spacemap/"

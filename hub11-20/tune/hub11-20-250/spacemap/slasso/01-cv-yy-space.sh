...
#SBATCH -o /home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/spacemap/01-cv-yy-space/logs/d%j.out
#SBATCH -e /home/cconley/scratch-data/sim-spacemap/hub11-20/2016/results/n250/spacemap/01-cv-yy-space/logs/d%j.err
...
/usr/bin/R --no-save --no-restore --no-site-file --no-init-file  --args ${SLURM_ARRAY_TASK_ID} 4 < 01-cv-yy-space.R 
